...
const customHtmlPreset = {
  ...
  editorConfig: {
    ...
    // Allow admonition block structure via General HTML Support
    htmlSupport: {
      allow: [
        {
          name: "div",
          classes: /^admonition__/,
        },
        {
          name: "a",
          classes: /^admonition__/,
